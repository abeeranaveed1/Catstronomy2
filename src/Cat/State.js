...
const State = ({navigation,route}) => {
  const [catState,setCatState] = React.useState('first')
  ...
  shadowRadius: 1, elevation: 25}}>
    <Styling title="State" style={{alignSelf:'flex-start', marginLeft:24, color:'purple', fontSize:16}}/>
      
      <View style={{ flexDirection: 'row', flex: 0.15, justifyContent: 'space-between', alignItems: 'center', width:wp(75)}}>
